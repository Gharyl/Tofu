...
Though this is a long way to go, I might dabble in Adobe After Effects to create my own custom animations and import into a Swift project using Lottie. But as for my next step, SwiftUI, CoreData, CloudKit, and CoreML are on the list of things I want to do!
